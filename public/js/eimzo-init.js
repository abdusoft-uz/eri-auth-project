...
var errorCAPIWS = 'E-IMZO bilan bog\'lanishda xatolik. E-IMZO dasturi o\'rnatilmagan bo\'lishi mumkin.';
var errorBrowserWS = 'Brauzer WebSocket texnologiyasini qo\'llab-quvvatlamaydi. Brauzeringizni yangilang.';
var errorUpdateApp = 'DIQQAT !!! E-IMZO dasturining yangi versiyasini o\'rnating.<br /><a href="https://e-imzo.uz/main/downloads/" role="button">E-IMZO dasturini yuklab olish</a>';
...
var uiShowProgress = function () {
    console.log('Loading indicator ko\'rsatilmoqda...');
};

var uiHideProgress = function () {
    console.log('Loading indicator yashirilmoqda...');
};
...
console.log('✅ E-IMZO Init kutubxonasi yuklandi');
